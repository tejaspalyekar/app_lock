...
class DeviceApps {
          ...
          if (app is Map) {
            try {
              ...
              if (e is AssertionError) {
                debugPrint(
                    '[DeviceApps] Unable to add the following app: $app');
              } else {
  ...
  static Stream<ApplicationEvent> listenToAppsChanges() {
    return _eventChannel
        ...
        .map<ApplicationEvent>((dynamic event) {
      if (event is Map<dynamic, dynamic>) {
        return ApplicationEvent._(event);
      }
...
class Application extends _BaseApplication {
  ...
  Application._(Map<dynamic, dynamic> map)
  ...
  Application._fromMap(Map<dynamic, dynamic> map) : this._(map);
